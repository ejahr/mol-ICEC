...
DIR_DATA = os.path.join(DIR, 'HLiH/data')           # dir name where PI XS data is located
DIR_RESULTS = os.path.join(DIR, 'HLiH/results')     # dir name where results should be saved
DIR_PLOTS = os.path.join(DIR, 'HLiH/plots')         # dir name where plots should be saved       
