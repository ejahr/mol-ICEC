...
# NIST
IP_H = 13.598434599702 * Units.EV2HARTREE
...
deg_1S = 1
deg_factor_B = 6
IP_B = 8.298019 * Units.EV2HARTREE
...
IP_LiH = 7.7 * Units.EV2HARTREE
#IP_LiH = 7.9 * Units.EV2HARTREE
...
wexe_LiH    = 23.5777 * Units.WAVENUMBER2HARTREE

r_mu        = (m_H*Req + m_Li*0) / (m_H + m_Li)
...
vib_spacing_LiH *= Units.WAVENUMBER2HARTREE
...
alpha       = 0.507 
wexe_LiHp   = 42.3 * Units.WAVENUMBER2HARTREE
De          = we**2 / 4 / wexe_LiHp 
...
vib_spacing_LiHp *= Units.WAVENUMBER2HARTREE
...
max_kinE_unresolved = energies[-1]*Units.EV2HARTREE - IP_H
...
input_HLiH_fixed = (deg_factor_H, IP_H*Units.HARTREE2EV, IP_LiH*Units.HARTREE2EV, PI_xs_H_eVMb, PI_xs_LiH_eVMb)
